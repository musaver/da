                ...
                <div className="card-body">
                  <form>
                    <div className="row">
                      <div className="col-lg-6">
                        <div className="mb-4 mb-lg-10">
                          <label htmlFor="Fname" className="form-label">Your Name</label>
                          <input type="text" name="Fname" id="Fname" placeholder="Enter your name" className="form-control" />
                        </div>
                      </div>
                      <div className="col-lg-6">
                        <div className="mb-4 mb-lg-10">
                      ...
                      <div className="col-lg-6">
                        <div className="mb-4 mb-lg-10">
                          <label htmlFor="interested" className="form-label">What are you interested in?</label>
                          <select className="form-select">
                            <option value="1">Design & Branding</option>
                            <option value="2">Ecommerce</option>
                            <option value="3">SEO Optimization</option>
                            <option value="4">Custom Development</option>
                          </select>
                        </div>
                      </div>
                      <div className="col-lg-6">
                    ...
                    <button type="submit" className="btn btn-dark mx-auto">
                      ...
                      <IconifyIcon icon="solar:arrow-right-up-linear"
