    ...
    <footer className="footer pt-md-11 pt-lg-12 pt-xl-13">
      <div className="container">
        <div className="py-11 py-5 py-lg-12 pb-0 pb-lg-12">
          <div className="row">
            {/* Company Info */}
            <div className="col-12 col-lg-4 mb-11 mb-lg-0">
              <div className="d-flex flex-column gap-4 me-xl-5">
                ...
                <div className="d-flex flex-column gap-2">
                  <a className="link-hover text-body" href="tel:03006825223">
                    <iconify-icon icon="solar:phone-linear" className="me-2"></iconify-icon>
                    +92 300 6825223
                  </a>
                  <a className="link-hover text-body" href="mailto:hello@devaspire.com">
                    <iconify-icon icon="solar:letter-linear" className="me-2"></iconify-icon>
                    hello@devaspire.com
                  </a>
                </div>
              </div>
            ...
            <div className="col-6 col-md-3 col-lg-2 mb-11 mb-lg-0">
              <div className="d-flex flex-column gap-3">
                ...
                <ul className="footer-menu list-unstyled mb-0 d-flex flex-column gap-7">
                  ...
                  <li><Link className="link-hover text-body" href="/contact">Contact</Link></li>
                </ul>
              </div>
            </div>
            ...
            <div className="col-6 col-md-3 col-lg-2 mb-11 mb-lg-0">
              <div className="d-flex flex-column gap-3">
                ...
                <ul className="footer-menu list-unstyled mb-0 d-flex flex-column gap-7">
                  ...
                  <li><Link className="link-hover text-body" href="/services/shopify-development">Shopify</Link></li>
                  <li><Link className="link-hover text-body" href="/services/digital-marketing">Marketing</Link></li>
                </ul>
              </div>
            </div>

            {/* Industries & Locations */}
            <div className="col-12 col-md-6 col-lg-4 mb-11 mb-lg-0">
              <div className="row">
                <div className="col-6">
                  <div className="d-flex flex-column gap-3">
        ...
        <div className="py-4 border-top">
          <div className="row align-items-center">
            <div className="col-md-6 text-center text-md-start">
              <p className="mb-0">©{new Date().getFullYear()} Dev Aspire. All Rights Reserved</p>
            </div>
            <div className="col-md-6 text-center text-md-end mt-3 mt-md-0">
              <div className="d-flex gap-3 justify-content-center justify-content-md-end">
                <Link className="link-hover text-body fs-4" href="/privacy-policy">Privacy Policy</Link>
                <span className="text-muted">|</span>
                <Link className="link-hover text-body fs-4" href="/terms-and-conditions">Terms & Conditions</Link>
              </div>
            </div>
          </div>
        </div>
